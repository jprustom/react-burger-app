...
function getIngredient(ingredientType){
    switch(ingredientType){
        ...
        case('meat'):
            return <div className={BurgerIngredientsStyles.Meat}></div> 
        case('cheese'):
            return <div className={BurgerIngredientsStyles.Cheese}></div> 
        case('salad'):
            return <div className={BurgerIngredientsStyles.Salad}></div> 
        case('bacon'):
            return <div className={BurgerIngredientsStyles.Bacon}></div> 
        default: //should never get here because we used PropTypes validation
            throw new Error(`unknown type ${ingredientType}`)
    }
}
const burgerIngredient=props=>getIngredient(props.ingredientType)
